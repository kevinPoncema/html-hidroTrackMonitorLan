...
export declare const queryElementByClassName: (className: string, container?: HTMLElement | null) => HTMLElement | null;
export declare const queryElementsByClassName: (className: string, container?: HTMLElement | null) => NodeListOf<HTMLElement>;
export declare const getElementByClassName: (className: string, container?: HTMLElement | null) => HTMLElement;
